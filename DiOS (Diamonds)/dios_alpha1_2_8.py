...
"""
    ...
    def run_bios(self):
        while True:
            ...
            c = input("Select > ")
            if c == '1':
                print(f"OS: DiOS {self.version}"); input("Enter...")
            elif c == '2':
                print("[1] DiOS Virtual Drive"); input("Enter...")
            elif c == '3':
                print(f"CPU Temp: {random.randint(35, 45)}°C"); input("Enter...")
            elif c == '4':
                self.current_state = "boot"; break
    ...
    def run_admin_panel(self):
        ...
        while True:
            ...
            if cmd == "home":
                ...
                print(">>> PLEASE STAND BY FOR 9 SECONDS...{THEMES['standard']}")
                # Ждем 9 секунд
                for i in range(9):
                    self.beep(1500, 50)
                    time.sleep(1)
    ...
    def run_settings(self):
        while True:
            ...
            if c == 'q':
                ...
                print(f"OS: DiOS v{self.version}"); input("Enter...")
            elif c == '2':
...
app.run()"""
    ...
    def run_os_loop(self):
        ...
        while self.current_state == "os":
            ...
            if cmd == "1191":
                self.current_state = "shutdown_to_admin"; break
            elif cmd == "3":
                self.current_state = "power_off"; break
            elif cmd == "help":
