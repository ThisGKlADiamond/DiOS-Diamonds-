...
class DiOS:
    def __init__(self):
        ...
        self.version = "alpha 1.4.8"  # UPDATED VERSION
    ...
    def login(self):
        while True:
            ...
            if name in self.users_db and pwd == self.users_db[name]["password"]:
                ...
                self.user_data.setdefault("wallpaper", "black") # DEFAULT WALLPAPER MIGRATION
                self.update_title()
    ...
    def execute_command(self, cmd_str, is_sudo=False):
        ...
        if cmd == "1191":
            ...
            if self.current_user == "root":
                ...
                if (self.current_user in self.users_db and pwd == self.users_db[self.current_user].get("password", "")) or pwd == self.root_password:
                    self.execute_command(" ".join(parts[1:]), is_sudo=True)
                else:
