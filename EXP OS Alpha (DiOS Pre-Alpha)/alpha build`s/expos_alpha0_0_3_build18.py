"""
EXP OS / ЕХП ОС
Version: alpha 0.0.3 Build 17
Description: Advanced terminal-based OS simulation with Multi-language support (RU, EN, FR, NL).
Features: Virtual FS, Network Sim, Media Viewer, Scripting, Games, File Menu, Integrated Settings.
"""
...
# Единый логотип для загрузки и SysInfo
LOGO_ASCII = """
       .-----------------------.
     .'                         '.
    /        EXP OS / ЕХП ОС      \\
...
LANGUAGES = {
    'ru': {
        ...
        'avail_cmd': "Доступные команды на рабочем столе:",
        ...
        'hint_refresh': "Обновление интерфейса", 'hint_color': "Смена цвета терминала",
    ...
    'en': {
        ...
        'avail_cmd': "Available Desktop Commands:",
        ...
        'lang_choose': "Available: en, ru, fr, nl.\nChoose: ",
        ...
        'hint_refresh': "Refresh interface", 'hint_color': "Change terminal color",
    ...
    'fr': {
        ...
        'menu_prompt': "Menu > ",
        'menu_help': "Options: 'settings' (paramètres), 'restart' (redémarrer), 'shutdown' (arrêter), 'back' (retour)",
        'set_title': "--- Paramètres ---",
        'set_prompt': "Paramètres > ",
        'set_help': "Options: 'sysinfo', 'lang', 'datetime', 'color', 'back'",
        'lang_choose': "Disponible: en, ru, fr, nl.\nChoisissez: ",
    ...
    'nl': {
        ...
        'lang_choose': "Beschikbaar: en, ru, fr, nl.\nKies: ",
...
class EXPOS:
    def __init__(self):
        ...
        self.version = "alpha 0.0.3 Build 18"
        self.username = "User"
        self.lang = "ru"
        self.ui_color = "white"
        ...
        # Команды "Рабочего стола" с привязанными ключами подсказок
        # ВАЖНО: 'sysinfo' и 'exit' убраны отсюда. Доступ к ним только через 'menu'.
        self.commands = {
    ...
    def run_installation(self):
        ...
        while True:
            ...
            if name:
                self.username = name
                break
        self.lang = "en"  # Дефолт при установке
        self.save_config()
    ...
    def cmd_help(self, args):
        print(f"\n{self.t('avail_cmd')}")
        print("-" * 50)
        # Сортируем и выводим с подсказками
    ...
    def cmd_fmenu(self, args):
        while True:
            ...
            if c == '0':
                ...
                try:
                    shutil.copy(path, '.'); print("Imported.")
                except Exception as e:
                    print(f"Error: {e}")
    ...
    # --- Меню и Настройки (Sysinfo и Time Config здесь) ---
    ...
    def execute_command(self, cmd_line):
        ...
        # Системные команды скрыты за menu, если их тут ввести - ошибка
    ...
    def start(self):
        ...
        while self.running:
            try:
                ...
                prompt = f"{color_code}[{self.username}@expos]$ {COLORS['reset']}"
