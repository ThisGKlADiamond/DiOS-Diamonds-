...
class DiOS:
    def __init__(self):
        ...
        self.user = "Guest"
        self.version = "alpha 1.3.1"  # Обновленная версия
...
update    : Check for OS updates (NEW)
sysmon    : System Resource Monitor (NEW)
backup    : Backup system config (NEW)
restore   : Restore system config (NEW)
history   : Show command history (NEW)

--- File Manager ---
files       : File Explorer (View files)
cd <dir>    : Change directory (NEW)
mkdir <dir> : Create directory (NEW)
rm <target> : Remove file/directory (NEW)
...
"""
    ...
    def backup_system(self):
        if os.path.exists(self.config_file):
            ...
            self.set_notify("💾 Бэкап успешно создан")
    ...
    def restore_system(self):
        if os.path.exists(self.backup_file):
            ...
            self.load_system()
            self.set_notify("🔄 Система восстановлена")
        ...
        while True:
            ...
            if c == 'q':
                ...
                if tc in colors:
                    ...
                    self.save_system()
                    self.set_notify("Тема обновлена")
            elif c == '3':
...
app.run()"""
    ...
    def run_store(self):
        ...
        if choice in apps and apps[choice][1] not in self.user_data["installed_apps"]:
            ...
            self.save_system()
            self.set_notify(f"Установлено: {apps[choice][0]}")
    ...
    def run_calculator(self):
        ...
        while True:
            ...
            if expr == 'q':
                ...
                self.set_notify("Калькулятор свернут");
                break
            try:
    ...
    def render_desktop(self):
        ...
        def run_update(self):
            ...
            try:
                ...
                # Замените на свою реальную ссылку на raw файл вашего репозитория
                url = "https://raw.githubusercontent.com/YourName/DiOS/main/version.txt"
